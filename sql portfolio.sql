...
SELECT CAST(SUM(number_of_Casualties) AS decimal(10,2))*100 /(SELECT CAST( SUM( number_of_Casualties) AS decimal(10,2)) FROM [road_accidents sql])   FROM [road_accidents sql] WHERE accident_severity = 'Slight'

SELECT CAST(SUM(number_of_Casualties) AS decimal(10,2))*100 /(SELECT CAST( SUM( number_of_Casualties) AS decimal(10,2)) FROM [road_accidents sql]) AS PCT  FROM [road_accidents sql] WHERE accident_severity = 'Serious'

SELECT CAST(SUM(number_of_Casualties) AS decimal(10,2))*100 /(SELECT CAST( SUM( number_of_Casualties) AS decimal(10,2)) FROM [road_accidents sql]) AS PCT  FROM [road_accidents sql] WHERE accident_severity = 'Fatal'
